...
filtered_df = merged_df[merged_df["event_name"] == "iraq_iran_earthquake"]

# Map labels
label_mapping = {"Infrastructure damage": 2, "Human damage": 1, "no_damage": 0}
filtered_df["label"] = filtered_df["humanitarian"].map(label_mapping)
...
id2label = { 0:"no_damage",1:"Human damage",2:"Infrastructure damage" }
