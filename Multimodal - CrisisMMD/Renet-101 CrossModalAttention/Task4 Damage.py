...
def load_and_clean(file_path, images_dir):
    ...
    df = df[['tweet_text', 'image', 'label']].rename(columns={'tweet_text':'text','label':'label_text'})
...
data_dir = ""
images_dir = ""
files = {"train":"task_damage_text_img_train.tsv","validation":"task_damage_text_img_dev.tsv","test":"task_damage_text_img_test.tsv"}
